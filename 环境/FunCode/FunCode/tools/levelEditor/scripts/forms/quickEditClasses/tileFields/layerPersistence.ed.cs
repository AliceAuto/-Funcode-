...
function LBQuickEditContent::createLayerPersistence(%this )
{
   ...
   %loadEffectButton = new GuiIconButtonCtrl() 
   {
      ...
      buttonMargin = "4 4";
      iconBitmap = expandFileName("^tools/levelEditor/gui/images/iconOpen.png");
      iconLocation = "Left";
      sizeIconToButton = "0";
      textLocation = "Right";
      textMargin = "4";
   ...
   %saveEffectButton = new GuiIconButtonCtrl() 
   {
      ...
      buttonType = "PushButton";
      buttonMargin = "4 4";
      iconBitmap = expandFileName("^tools/levelEditor/gui/images/iconSave.png");
      iconLocation = "Left";
      sizeIconToButton = "0";
      textLocation = "Right";
      textMargin = "4";   
...
function LayerLoadButton::onClick( %this )
{
   ...
   %fileName = T2DTileLayer::getLevelOpenName( %currentLayer );

...
public class EngineInterface implements EngineCall
{
	...
	* @param 参数 iMouseType：鼠标按键值，见 MouseTypes 定义
	* @param 参数 fMouseX,：为鼠标当前坐标
	* @param 参数 fMouseX, fMouseY：为鼠标当前坐标
	*/
	...
	* @param 参数 iKey：被按下的键，值见 KeyCodes 宏定义
	* @param 参数 bAltPress, bShiftPress，bCtrlPress：键盘上的功能键Alt，Ctrl，Shift当前是否也处于按下状态
	*/
	...
	* @param 参数 iKey：弹起的键，值见 KeyCodes 宏定义
	*/

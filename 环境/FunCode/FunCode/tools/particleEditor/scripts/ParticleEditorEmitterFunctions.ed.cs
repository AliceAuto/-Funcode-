...
function LevelBuilderParticleEditor::readEmitterFields(%this)
{
   ...
   if(!isObject(%particleEmitter))
	...
	ParticleEditorEmitterComAnimation.setSelected( ParticleEditorEmitterComAnimation.findText( %particleEmitter.getAnimationName() ) );	

	// Fetch Blending.
	%blending = %particleEmitter.getBlending();
	// Set Src/Dst Blend Factors.
	ParticleEditorEmitterComSrcBlend.setSelected( ParticleEditorEmitterComSrcBlend.findText( getWord(%blending, 1) ) );
	ParticleEditorEmitterComDstBlend.setSelected( ParticleEditorEmitterComDstBlend.findText( getWord(%blending, 2) ) );
	
	// Read Misc Options.
	ParticleEditorEmitterOptBlendParticles.setValue( getWord(%blending, 0 ) );

//-----------------------------------------------------------------------------
// Particle Editor EmitterGraph Field Class
...
function TGBEmitterFieldList::initGraph(%this)
{
   ...
   // particlelife_base
   %this.AddGraphEntry( "Particle Life Base", "particlelife_base", 0, 10, 0, 1 );   
   // particlelife_var
   %this.AddGraphEntry( "Particle Life Variance", "particlelife_var", 0, 10, 0, 1 );  
   // quantity_base
   %this.AddGraphEntry( "Quantity Base", "quantity_base", 0, 100, 0, 1 );   
   // quantity_var
   %this.AddGraphEntry( "Quantity Variance", "quantity_var", 0, 100, 0, 1 );   
   // sizex_base
   %this.AddGraphEntry( "Size X Base", "sizex_base", 0, 100, 0, 1 );  
   // sizex_var
   %this.AddGraphEntry( "Size X Variance", "sizex_var", 0, 100, 0, 1 );   
   // sizex_life
   %this.AddGraphEntry( "Size X Life", "sizex_life", -10, 10, 0, 1 );   
   // sizey_base
   %this.AddGraphEntry( "Size Y Base", "sizey_base", 0, 100, 0, 1 );   
   // sizey_var
   %this.AddGraphEntry( "Size Y Variance", "sizey_var", 0, 100, 0, 1 );
   // sizey_life
   %this.AddGraphEntry( "Size Y Life", "sizey_life", -10, 10, 0, 1 );
   // speed_base
   %this.AddGraphEntry( "Speed Base", "speed_base", 0, 1000, 0, 1 );
   // speed_var
   %this.AddGraphEntry( "Speed Variance", "speed_var", 0, 1000, 0, 1 );   
   // speed_life
   %this.AddGraphEntry( "Speed Life", "speed_life", -100, 100, 0, 1 );   
   // spin_base
   %this.AddGraphEntry( "Spin Base", "spin_base", -3600, 3600, 0, 1 );      
   // spin_var
   %this.AddGraphEntry( "Spin Variance", "spin_var", 0, 1000, 0, 1 );      
   // spin_life
   %this.AddGraphEntry( "Spin Life", "spin_life", -100, 100, 0, 1 );      
   // fixedforce_base
   %this.AddGraphEntry( "Fixed Force Base", "fixedforce_base", -1000, 1000, 0, 1 );      
   // fixedforce_var
   %this.AddGraphEntry( "Fixed Force Variance", "fixedforce_var", 0, 2000, 0, 1 );      
   // fixedforce_life
   %this.AddGraphEntry( "Fixed Force Life", "fixedforce_life", -100, 100, 0, 1 );      
   // randommotion_base
   %this.AddGraphEntry( "Random Motion Base", "randommotion_base", 0, 1000, 0, 1 );      
   // randommotion_var
   %this.AddGraphEntry( "Random Motion Variance", "randommotion_var", 0, 1000, 0, 1 );    
   // randommotion_life
   ...
   // emissionangle_base
   %this.AddGraphEntry( "Emission Angle Base", "emissionangle_base", -360, 360, 0, 1 );       
   // emissionangle_var
